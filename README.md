...
[![GitHub License](https://img.shields.io/github/license/Tarunjit45/OmniAnalyzer-AI?style=flat-square)](LICENSE)
[![CI / Quality Check](https://github.com/Tarunjit45/OmniAnalyzer-AI/actions/workflows/ci.yml/badge.svg)](https://github.com/Tarunjit45/OmniAnalyzer-AI/actions)
[![Language](https://img.shields.io/badge/Language-JavaScript/TypeScript-blue?style=flat-square)](https://github.com/Tarunjit45/OmniAnalyzer-AI)
...
```bash
git clone https://github.com/Tarunjit45/OmniAnalyzer-AI.git
cd OmniAnalyzer-AI
```
